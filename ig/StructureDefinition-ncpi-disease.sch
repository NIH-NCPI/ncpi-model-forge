...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ncpi-project-forge.io/StructureDefinition/age-at-event']) &lt;= 1">extension with URL = 'http://fhir.ncpi-project-forge.io/StructureDefinition/age-at-event': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
